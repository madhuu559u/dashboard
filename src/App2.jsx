...
/* ═══════════════════ THEMES ═══════════════════ */
const TH = {
  cyber:{nm:"CYBER OPS",ic:"\u26A1",ac:"#00e8ff",a2:"#00ff80",wr:"#ffab00",dg:"#ff1744",pr:"#b455ff",tx:"#e0f0ff",mt:"rgba(224,240,255,.65)",dm:"rgba(224,240,255,.35)",gl:"rgba(8,18,38,.72)",bd:"rgba(0,232,255,.10)",gr:"rgba(0,232,255,.06)",ms:"dark",mf:"brightness(1.08) contrast(1.08) saturate(1.1)",hd:"'Orbitron',monospace",by:"'Rajdhani',sans-serif",mn:"'JetBrains Mono',monospace",bgBase:"#0a1628",scanlines:true,brackets:true,glow:true,cardBg:"rgba(10,22,42,.72)",cardBorder:"rgba(0,212,245,.16)",headerBg:"linear-gradient(180deg,rgba(10,22,42,.92) 0%,rgba(10,22,42,.60) 50%,rgba(10,22,42,.15) 85%,transparent)",vignette:"radial-gradient(ellipse 140% 120% at 50% 50%,transparent 60%,rgba(0,8,20,.06) 85%,rgba(0,0,0,.10))",mapSat:-0.08,mapCon:0.12,mapBrMin:0.10,mapBrMax:0.68,mkGlow:"0 0 12px rgba(0,232,255,.6),0 0 24px rgba(0,232,255,.2)",btnBg:"rgba(0,232,255,.12)",btnBorder:"rgba(0,232,255,.35)",btnTx:"#00e8ff"},
  solar:{nm:"SOLAR FLARE",ic:"\u2600\uFE0F",ac:"#e8590c",a2:"#f59f00",wr:"#fd7e14",dg:"#c92a2a",pr:"#ae3ec9",tx:"#1a1a2e",mt:"rgba(26,26,46,.65)",dm:"rgba(26,26,46,.40)",gl:"rgba(255,252,245,.72)",bd:"rgba(232,89,12,.10)",gr:"rgba(232,89,12,.06)",ms:"light",mf:"brightness(1.15) contrast(1.0) saturate(1.25)",hd:"'Bebas Neue',sans-serif",by:"'DM Sans',sans-serif",mn:"'Source Code Pro',monospace",bgBase:"#fef8f0",scanlines:false,brackets:false,glow:false,cardBg:"rgba(255,252,245,.72)",cardBorder:"rgba(232,89,12,.18)",headerBg:"linear-gradient(180deg,rgba(255,252,245,.85) 0%,rgba(255,252,245,.25) 70%,transparent)",vignette:"radial-gradient(ellipse 140% 120% at 50% 50%,transparent 60%,rgba(255,200,120,.04) 85%,rgba(200,100,0,.06))",mapSat:0.2,mapCon:0.05,mapBrMin:0.38,mapBrMax:1.0,mkGlow:"0 0 10px rgba(232,89,12,.5),0 0 20px rgba(245,159,0,.2)",btnBg:"rgba(232,89,12,.12)",btnBorder:"rgba(232,89,12,.35)",btnTx:"#c04a0a"},
  arctic:{nm:"ARCTIC ZERO",ic:"\u2744\uFE0F",ac:"#4c8dbf",a2:"#5fad8e",wr:"#d4a030",dg:"#c44040",pr:"#7b5ea7",tx:"#1a2a3a",mt:"rgba(26,42,58,.60)",dm:"rgba(26,42,58,.35)",gl:"rgba(238,246,252,.72)",bd:"rgba(76,141,191,.10)",gr:"rgba(76,141,191,.06)",ms:"light",mf:"brightness(1.08) contrast(1.0) saturate(0.85) hue-rotate(-3deg)",hd:"'Quicksand',sans-serif",by:"'Nunito',sans-serif",mn:"'Fira Code',monospace",bgBase:"#eef4fa",scanlines:false,brackets:false,glow:false,cardBg:"rgba(238,246,252,.72)",cardBorder:"rgba(76,141,191,.18)",headerBg:"linear-gradient(180deg,rgba(238,246,252,.85) 0%,rgba(238,246,252,.25) 70%,transparent)",vignette:"radial-gradient(ellipse 140% 120% at 50% 50%,transparent 60%,rgba(180,210,240,.05) 85%,rgba(100,150,200,.08))",mapSat:-0.3,mapCon:0.0,mapBrMin:0.32,mapBrMax:1.0,mkGlow:"0 0 10px rgba(76,141,191,.5),0 0 20px rgba(95,173,142,.2)",btnBg:"rgba(76,141,191,.12)",btnBorder:"rgba(76,141,191,.35)",btnTx:"#3a7aaa"},
  terminal:{nm:"TERMINAL",ic:"\u25B6",ac:"#00ff80",a2:"#00ccff",wr:"#ffb300",dg:"#ff5555",pr:"#bd93f9",tx:"#b0ffd0",mt:"rgba(176,255,208,.60)",dm:"rgba(176,255,208,.35)",gl:"rgba(1,8,4,.58)",bd:"rgba(0,255,128,.10)",gr:"rgba(0,255,128,.06)",ms:"dark",mf:"brightness(.88) contrast(1.32) saturate(1.1) hue-rotate(8deg)",hd:"'VT323',monospace",by:"'VT323',monospace",mn:"'VT323',monospace",bgBase:"#010804",scanlines:true,brackets:true,glow:true,cardBg:"rgba(1,12,4,.55)",cardBorder:"rgba(0,255,128,.18)",headerBg:"linear-gradient(180deg,rgba(1,8,3,.75) 0%,rgba(1,6,2,.20) 70%,transparent)",vignette:"radial-gradient(ellipse 125% 125% at 50% 50%,transparent 35%,rgba(0,8,0,.16) 65%,rgba(0,0,0,.35))",mapSat:-0.45,mapCon:0.28,mapBrMin:0.02,mapBrMax:0.48,mkGlow:"0 0 14px rgba(0,255,128,.7),0 0 28px rgba(0,255,128,.2)",btnBg:"rgba(0,255,128,.12)",btnBorder:"rgba(0,255,128,.35)",btnTx:"#00ff80"},
  obsidian:{nm:"OBSIDIAN LUXE",ic:"\u25C6",ac:"#c8a84e",a2:"#a89050",wr:"#d4a030",dg:"#b03030",pr:"#7b4fa0",tx:"#f0ebe0",mt:"rgba(240,235,224,.60)",dm:"rgba(240,235,224,.35)",gl:"rgba(12,10,6,.58)",bd:"rgba(200,168,78,.10)",gr:"rgba(200,168,78,.06)",ms:"dark",mf:"brightness(0.92) contrast(1.18) saturate(0.82) sepia(0.18)",hd:"'Playfair Display',serif",by:"'Cormorant Garamond',serif",mn:"'IBM Plex Mono',monospace",bgBase:"#0a0806",scanlines:false,brackets:false,glow:true,cardBg:"rgba(16,12,6,.55)",cardBorder:"rgba(200,168,78,.18)",headerBg:"linear-gradient(180deg,rgba(12,10,6,.75) 0%,rgba(10,8,5,.20) 70%,transparent)",vignette:"radial-gradient(ellipse 130% 120% at 50% 50%,transparent 48%,rgba(8,6,2,.14) 75%,rgba(0,0,0,.28))",mapSat:-0.2,mapCon:0.18,mapBrMin:0.06,mapBrMax:0.58,mkGlow:"0 0 10px rgba(200,168,78,.5),0 0 22px rgba(200,168,78,.15)",btnBg:"rgba(200,168,78,.12)",btnBorder:"rgba(200,168,78,.35)",btnTx:"#c8a84e"},
};
...
/* ═══════════════════ MAP UTILITIES ═══════════════════ */
function buildMapStyle(T){var dk=T.ms==="dark";return{version:8,sources:{osm:{type:"raster",tiles:["https://a.tile.openstreetmap.org/{z}/{x}/{y}.png"],tileSize:256},esri:{type:"raster",tiles:["https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}"],tileSize:256},labels:{type:"raster",tiles:["https://a.basemaps.cartocdn.com/"+(dk?"dark":"light")+"_only_labels/{z}/{x}/{y}@2x.png"],tileSize:256}},layers:[{id:"bg",type:"background",paint:{"background-color":T.bgBase}},{id:"osm",type:"raster",source:"osm",paint:{"raster-saturation":T.mapSat,"raster-contrast":T.mapCon,"raster-brightness-min":T.mapBrMin,"raster-brightness-max":T.mapBrMax}},{id:"sat",type:"raster",source:"esri",paint:{"raster-opacity":dk?1:0.25,"raster-saturation":0.12,"raster-contrast":0.15,"raster-brightness-min":T.mapBrMin,"raster-brightness-max":T.mapBrMax}},{id:"labels",type:"raster",source:"labels",paint:{"raster-opacity":dk?0.6:0.8}}]};}
function createMarker(color,T,sz){sz=sz||28;var w=document.createElement("div");w.className="nf-marker";w.style.cssText="position:relative;width:"+sz+"px;height:"+sz+"px;cursor:pointer;";var r1=document.createElement("div");r1.style.cssText="position:absolute;top:50%;left:50%;width:"+(sz+8)+"px;height:"+(sz+8)+"px;margin:-"+((sz+8)/2)+"px 0 0 -"+((sz+8)/2)+"px;border-radius:50%;border:1px solid "+color+"40;animation:mp 3s ease-in-out infinite;pointer-events:none;";w.appendChild(r1);var r2=document.createElement("div");r2.style.cssText="position:absolute;top:50%;left:50%;width:"+(sz+16)+"px;height:"+(sz+16)+"px;margin:-"+((sz+16)/2)+"px 0 0 -"+((sz+16)/2)+"px;border-radius:50%;border:1px solid "+color+"18;animation:mp 3s ease-in-out 1s infinite;pointer-events:none;";w.appendChild(r2);var bg=document.createElement("div");bg.style.cssText="position:absolute;top:50%;left:50%;width:"+sz+"px;height:"+sz+"px;margin:-"+(sz/2)+"px 0 0 -"+(sz/2)+"px;border-radius:50%;background:radial-gradient(circle,"+color+"25 0%,"+color+"08 50%,transparent 70%);pointer-events:none;";w.appendChild(bg);var s3=Math.round(sz*0.38);var c=document.createElement("div");c.style.cssText="position:absolute;top:50%;left:50%;width:"+s3+"px;height:"+s3+"px;margin:-"+(s3/2)+"px 0 0 -"+(s3/2)+"px;border-radius:50%;background:radial-gradient(circle at 35% 35%,"+color+"ee,"+color+"aa 60%,"+color+"70);box-shadow:0 0 10px "+color+"80,0 0 20px "+color+"30,inset 0 1px 2px rgba(255,255,255,.3);transition:transform .25s cubic-bezier(.34,1.56,.64,1);";w.appendChild(c);var s4=Math.round(sz*0.12);var dot=document.createElement("div");dot.style.cssText="position:absolute;top:50%;left:50%;width:"+s4+"px;height:"+s4+"px;margin:-"+(s4/2)+"px 0 0 -"+(s4/2)+"px;border-radius:50%;background:rgba(255,255,255,.9);box-shadow:0 0 4px rgba(255,255,255,.5);";w.appendChild(dot);w.onmouseenter=function(){c.style.transform="scale(1.35)"};w.onmouseleave=function(){c.style.transform="scale(1)"};return w;}
...
function TickerBar({T}){var ref=useRef(0);var[,setTick]=useState(0);useEffect(function(){var id=setInterval(function(){ref.current-=0.5;setTick(t=>t+1)},30);return ()=>clearInterval(id)},[]);var items=TICKER.concat(TICKER);if(ref.current<-(TICKER.length*400))ref.current=0;return(<div style={{overflow:"hidden",width:"100%",height:18,position:"relative"}}><div style={{display:"flex",gap:60,position:"absolute",left:0,top:0,transform:"translateX("+ref.current+"px)",whiteSpace:"nowrap",willChange:"transform"}}>{items.map((t,i)=><span key={i} style={{fontFamily:T.mn,fontSize:8,color:T.mt,letterSpacing:.5,flexShrink:0}}>{t}</span>)}</div></div>);}

function AlertScroller({T}){var ref=useRef(0);var[,setTick]=useState(0);useEffect(function(){var id=setInterval(function(){ref.current-=0.4;setTick(t=>t+1)},30);return ()=>clearInterval(id)},[]);var totalH=ALERTS.length*52;if(ref.current<-totalH)ref.current=0;var items=ALERTS.concat(ALERTS);return(<div style={{overflow:"hidden",height:100,position:"relative"}}><div style={{position:"absolute",left:0,right:0,top:0,transform:"translateY("+ref.current+"px)",willChange:"transform"}}>{items.map((a,i)=>{var sevColor=a.sev==="CRITICAL"?T.dg:a.sev==="HIGH"?T.wr:a.sev==="MEDIUM"?T.ac:T.a2;return <div key={i} style={{padding:"4px 6px",marginBottom:3,borderRadius:5,background:sevColor+"08",borderLeft:"3px solid "+sevColor,fontSize:8,fontFamily:T.mn}}><div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:1}}><span style={{fontSize:7,padding:"1px 5px",borderRadius:3,fontWeight:700,background:sevColor+"18",color:sevColor,letterSpacing:.8}}>{a.sev}</span><span style={{fontSize:7,color:T.dm}}>{a.time}</span></div><div style={{color:T.tx,lineHeight:1.3,fontSize:7.5}}>{a.msg}</div></div>})}</div></div>);}
...
return(
<div style={{position:"fixed",top:55,right:314,zIndex:25,pointerEvents:"auto",animation:"slideIn .4s ease",width:420,maxWidth:"38vw",maxHeight:"calc(100vh - 75px)",overflow:"auto"}}>
...
<div style={{width:38,height:38,borderRadius:8,background:col+"10",border:"1.5px solid "+col+"20",display:"flex",alignItems:"center",justifyContent:"center",fontSize:20}}>{TI[fac.t]||"\u2699"}</div>
...
{/* KPI Grid */}
<div style={{padding:"8px 16px",display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:6}}>
...
var mapRef=useRef(null);var mcRef=useRef(null);var markersRef=useRef([]);var T=TH[theme];var isDark=T.ms==="dark";
...
s.textContent="*{box-sizing:border-box;margin:0;padding:0}html,body,#root{width:100%;height:100%;overflow:hidden;background:"+T.bgBase+"}#nf-map{position:absolute;top:0;left:0;width:100%;height:100%}#nf-map canvas,.maplibregl-canvas-container,.maplibregl-canvas{width:100%!important;height:100%!important}@keyframes hu{from{opacity:0;transform:translateY(6px)}to{opacity:1;transform:translateY(0)}}@keyframes slideIn{from{opacity:0;transform:translateX(14px)}to{opacity:1;transform:translateX(0)}}@keyframes pu{0%,100%{opacity:1}50%{opacity:.3}}@keyframes ls{0%,100%{background-position:0% 50%}50%{background-position:100% 50%}}@keyframes mp{0%{transform:scale(1);opacity:.5}50%{transform:scale(1.6);opacity:0}100%{transform:scale(1);opacity:.5}}.maplibregl-ctrl-attrib,.maplibregl-ctrl-logo,.maplibregl-ctrl-group{display:none!important}.maplibregl-canvas{cursor:default!important}.maplibregl-grab,.maplibregl-grabbing,.maplibregl-canvas-container.maplibregl-interactive{cursor:default!important}::-webkit-scrollbar{width:3px}::-webkit-scrollbar-track{background:transparent}::-webkit-scrollbar-thumb{background:"+T.ac+"20;border-radius:3px}";},[theme,T]);

var flyTo=useCallback(function(f){var map=mapRef.current;if(!map)return;setSel(f);try{map.flyTo({center:[f.lon,f.lat],zoom:5.5,speed:0.8,curve:1.3,pitch:0,bearing:0,essential:true})}catch(e){}},[]);
var resetView=useCallback(function(){setSel(null);var map=mapRef.current;if(!map)return;try{map.flyTo({center:[40,20],zoom:2.2,speed:0.8,pitch:0,bearing:0,essential:true})}catch(e){}},[]);

/* Map Init */
useEffect(function(){var cancelled=false;function init(){if(cancelled)return;var el=mcRef.current;if(!el||!window.maplibregl){requestAnimationFrame(init);return}var r=el.getBoundingClientRect();if(r.width<40||r.height<40){requestAnimationFrame(init);return}
try{var map=new window.maplibregl.Map({container:el,style:buildMapStyle(TH.cyber),center:[40,20],zoom:2.2,pitch:0,bearing:0,attributionControl:false,trackResize:true,dragRotate:false,pitchWithRotate:false,touchPitch:false});mapRef.current=map;
map.on("load",function(){if(cancelled)return;try{map.setMinZoom(1.5);map.setMaxZoom(10)}catch(e){}
FAC.forEach(function(f){var lon=Number(f.lon),lat=Number(f.lat);if(!Number.isFinite(lon)||!Number.isFinite(lat))return;var sz=f.t==="hq"?38:f.t==="factory"?32:f.t==="port"?30:26;var el2=createMarker(TC[f.t]||TH.cyber.a2,TH.cyber,sz);el2.addEventListener("click",function(){setSel(f);try{map.flyTo({center:[lon,lat],zoom:5.5,speed:0.8,pitch:0})}catch(e){}});try{new window.maplibregl.Marker({element:el2,anchor:"center"}).setLngLat([lon,lat]).addTo(map);markersRef.current.push(el2)}catch(e){}});
SUPS.forEach(function(sup){var el3=createMarker("#f472b6",TH.cyber,18);el3.addEventListener("click",function(){setSel({n:sup.n,c:sup.c,r:"",lat:sup.lat,lon:sup.lon,t:"supplier",rev:sup.val/1000,staff:0,eff:sup.fill,issues:sup.risk>50?3:1,st:sup.risk>50?"DEG":"OK",cap:sup.cat,up:sup.otd+"%",d:sup.tier+" "+sup.cat+". Risk:"+sup.risk+", Lead:"+sup.lead+"d"})});try{new window.maplibregl.Marker({element:el3,anchor:"center"}).setLngLat([sup.lon,sup.lat]).addTo(map)}catch(e){}});
});}catch(e){console.error("Map:",e)}}
ld().then(function(){requestAnimationFrame(init)});return function(){cancelled=true;try{if(mapRef.current)mapRef.current.remove()}catch(e){}mapRef.current=null;}},[]);
...
<G title="CARRIER PERFORMANCE" icon={"\uD83D\uDCE6"} glow={T.a2} delay={120} T={T} style={{height:132}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><BarChart data={CARRIER_BAR.slice(0,8)} margin={{left:-5,right:2,top:2,bottom:0}}><CartesianGrid strokeDasharray="2 6" stroke={T.gr}/><XAxis dataKey="name" stroke={T.dm} fontSize={5.5} tickLine={false}/><YAxis stroke={T.dm} fontSize={6} tickLine={false}/><Tooltip content={<CT/>}/><Bar dataKey="count" fill={T.ac+"60"} barSize={7} name="Total"/><Bar dataKey="onTime" fill={T.a2} barSize={7} name="On-Time" radius={[2,2,0,0]}/></BarChart></ResponsiveContainer></div></G>
<G title="TRANSPORT MODE" icon={"\uD83D\uDE9B"} glow={T.pr} delay={180} T={T} style={{height:132}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><PieChart><Pie data={MODE_PIE} cx="50%" cy="50%" outerRadius={45} dataKey="value" strokeWidth={0} label={({name,value})=>name.substring(0,6)+":"+value}>{MODE_PIE.map((d,i)=><Cell key={i} fill={d.fill}/>)}</Pie><Tooltip content={<CT/>}/></PieChart></ResponsiveContainer></div></G></>;
...
<G title="RISK vs FILL SCATTER" icon={"\uD83C\uDFAF"} glow={T.wr} delay={120} T={T} style={{height:143}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><ScatterChart margin={{left:-5,right:2,top:2,bottom:0}}><CartesianGrid strokeDasharray="2 6" stroke={T.gr}/><XAxis dataKey="risk" name="Risk" stroke={T.dm} fontSize={6} tickLine={false}/><YAxis dataKey="fill" name="Fill%" stroke={T.dm} fontSize={6} tickLine={false} domain={[88,100]}/><Tooltip content={<CT/>}/><Scatter data={SUP_SCATTER} fillOpacity={0.7}>{SUP_SCATTER.map((s,i)=><Cell key={i} fill={s.risk>30?T.dg:s.risk>20?T.wr:T.a2}/>)}</Scatter></ScatterChart></ResponsiveContainer></div></G></>;
...
<G title="INVENTORY FUNNEL" icon={"\uD83D\uDCE6"} glow={T.wr} delay={120} T={T} style={{height:132}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><FunnelChart><Funnel dataKey="value" data={INV_FUNNEL} isAnimationActive><LabelList position="right" dataKey="name" fontSize={7} fill={T.mt}/>{INV_FUNNEL.map((d,i)=><Cell key={i} fill={d.fill}/>)}</Funnel><Tooltip content={<CT/>}/></FunnelChart></ResponsiveContainer></div></G>
<G title="VALUE BY MATERIAL" icon={"\uD83D\uDCC8"} glow={T.ac} delay={180} T={T} style={{height:132}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><BarChart data={INV_BY_MAT} layout="vertical" margin={{left:30,right:8,top:2,bottom:0}}><CartesianGrid strokeDasharray="2 6" stroke={T.gr}/><XAxis type="number" stroke={T.dm} fontSize={6} tickLine={false}/><YAxis type="category" dataKey="name" stroke={T.dm} fontSize={5.5} tickLine={false} width={50}/><Tooltip content={<CT/>}/><Bar dataKey="value" barSize={6} radius={[0,3,3,0]} name="Value ($K)">{INV_BY_MAT.map((d,i)=><Cell key={i} fill={d.fill}/>)}</Bar></BarChart></ResponsiveContainer></div></G></>;

/* ═══════════════════ DEFAULT: OVERVIEW — EVERY WIDGET TYPE ═══════════════════ */
default:return<>
{/* 1. SCROLLING ALERTS */}
<G title={"LIVE ALERTS"} icon={"\uD83D\uDEA8"} glow={T.dg} delay={40} T={T} badge={ALERTS.length+""}><AlertScroller T={T}/></G>

{/* 2. PO Status PIE */}
<G title="PO STATUS" icon={"\u25C6"} glow={T.ac} delay={80} T={T} badge={SM.totalPOs+""} style={{height:164}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><PieChart><Pie data={PO_PIE} cx="50%" cy="50%" innerRadius={26} outerRadius={54} dataKey="value" strokeWidth={0} label={({name,value})=>name.substring(0,5)+":"+value}>{PO_PIE.map((d,i)=><Cell key={i} fill={d.fill}/>)}</Pie><Tooltip content={<CT/>}/></PieChart></ResponsiveContainer></div></G>

{/* 3. Shipment Mode PIE */}
<G title="TRANSPORT MODES" icon={"\uD83D\uDE9B"} glow={T.pr} delay={120} T={T} badge={SM.totalShips+""} style={{height:152}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><PieChart><Pie data={MODE_PIE} cx="50%" cy="50%" outerRadius={48} dataKey="value" strokeWidth={0}>{MODE_PIE.map((d,i)=><Cell key={i} fill={d.fill}/>)}</Pie><Tooltip content={<CT/>}/></PieChart></ResponsiveContainer></div></G>

{/* 4. OEE RADIAL BAR */}
<G title="PLANT OEE" icon={"\uD83C\uDFED"} glow={T.a2} delay={160} T={T} style={{height:176}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><RadialBarChart innerRadius="15%" outerRadius="90%" data={OEE_RADIAL} startAngle={180} endAngle={0}><RadialBar dataKey="oee" cornerRadius={3} label={{position:"insideStart",fontSize:7,fill:T.tx}}>{OEE_RADIAL.map((d,i)=><Cell key={i} fill={d.fill}/>)}</RadialBar><Tooltip content={<CT/>}/></RadialBarChart></ResponsiveContainer></div></G>

{/* 5. Cost COMPOSED (Area+Bar) */}
<G title="COST BREAKDOWN" icon={"\uD83D\uDCB0"} glow={T.wr} delay={200} T={T} style={{height:164}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><ComposedChart data={COST_MO} margin={{left:-5,right:2,top:2,bottom:0}}><CartesianGrid strokeDasharray="2 6" stroke={T.gr}/><XAxis dataKey="name" stroke={T.dm} fontSize={6} tickLine={false}/><YAxis stroke={T.dm} fontSize={6} tickLine={false}/><Tooltip content={<CT/>}/><Area type="monotone" dataKey="inv" stroke={T.ac} fill={T.ac+"10"} strokeWidth={1} name="Inventory $K"/><Bar dataKey="freight" fill={T.dg+"60"} barSize={5} name="Freight $K"/><Bar dataKey="poVal" fill={T.a2+"60"} barSize={5} name="PO Value $K" radius={[2,2,0,0]}/></ComposedChart></ResponsiveContainer></div></G>

{/* 6. REGION RADAR */}
<G title="REGIONAL PROFILE" icon={"\uD83D\uDCE1"} glow={T.a2} delay={240} T={T} style={{height:164}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><RadarChart data={REG_RADAR.slice(0,6)}><PolarGrid stroke={T.gr}/><PolarAngleAxis dataKey="name" stroke={T.dm} fontSize={6}/><Radar name="Revenue" dataKey="rev" stroke={T.ac} fill={T.ac} fillOpacity={.1} strokeWidth={1.2}/><Radar name="Health" dataKey="health" stroke={T.a2} fill={T.a2} fillOpacity={.06} strokeWidth={1}/><Tooltip content={<CT/>}/></RadarChart></ResponsiveContainer></div></G>

{/* 7. SUPPLIER SCATTER */}
<G title="SUPPLIER RISK MAP" icon={"\u25C7"} glow={T.dg} delay={280} T={T} badge={SM.highRisk+" HIGH"} style={{height:152}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><ScatterChart margin={{left:-5,right:2,top:2,bottom:0}}><CartesianGrid strokeDasharray="2 6" stroke={T.gr}/><XAxis dataKey="risk" name="Risk" stroke={T.dm} fontSize={6} tickLine={false}/><YAxis dataKey="fill" name="Fill%" stroke={T.dm} fontSize={6} tickLine={false} domain={[88,100]}/><Tooltip content={<CT/>}/><Scatter data={SUP_SCATTER} fillOpacity={0.7}>{SUP_SCATTER.map((s,i)=><Cell key={i} fill={s.risk>30?T.dg:s.risk>20?T.wr:T.a2}/>)}</Scatter></ScatterChart></ResponsiveContainer></div></G>

{/* 8. INVENTORY FUNNEL */}
<G title="INVENTORY HEALTH" icon={"\uD83D\uDCE6"} glow={T.wr} delay={320} T={T} style={{height:139}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><FunnelChart><Funnel dataKey="value" data={INV_FUNNEL} isAnimationActive><LabelList position="right" dataKey="name" fontSize={7} fill={T.mt}/>{INV_FUNNEL.map((d,i)=><Cell key={i} fill={d.fill}/>)}</Funnel><Tooltip content={<CT/>}/></FunnelChart></ResponsiveContainer></div></G>

{/* 9. Weld & NDT LINE */}
<G title="QUALITY TRENDS" icon={"\uD83D\uDD27"} glow={T.ac} delay={360} T={T} style={{height:139}}><div style={{width:W,height:H}}><ResponsiveContainer width="100%" height="100%"><LineChart data={PROD_MO} margin={{left:-5,right:2,top:2,bottom:0}}><CartesianGrid strokeDasharray="2 6" stroke={T.gr}/><XAxis dataKey="name" stroke={T.dm} fontSize={6} tickLine={false}/><YAxis stroke={T.dm} fontSize={6} tickLine={false} domain={[80,100]}/><Tooltip content={<CT/>}/><Line type="monotone" dataKey="weld" stroke={T.ac} strokeWidth={1.5} dot={{r:2}} name="Weld%"/><Line type="monotone" dataKey="ndt" stroke={T.a2} strokeWidth={1.5} dot={{r:2}} name="NDT%"/></LineChart></ResponsiveContainer></div></G>

{/* 10 & 11 moved to bottom bar */}
</>;}}

return(<div style={{width:"100vw",height:"100vh",fontFamily:T.by,color:T.tx,position:"relative",background:T.bgBase}}>
<div id="nf-map" ref={mcRef} style={{position:"absolute",inset:0,zIndex:0,filter:T.mf}}/>
<div style={{position:"fixed",inset:0,pointerEvents:"none",zIndex:1,background:T.vignette}}/>
{T.scanlines?<div style={{position:"fixed",inset:0,pointerEvents:"none",zIndex:1,background:"repeating-linear-gradient(0deg,transparent,transparent 2px,"+T.ac+"01 2px,"+T.ac+"01 4px)",opacity:.15}}/>:null}
{T.brackets?<svg style={{position:"fixed",inset:0,zIndex:2,pointerEvents:"none",width:"100%",height:"100%"}} preserveAspectRatio="none" viewBox="0 0 1920 1080"><g stroke={T.ac} strokeWidth=".5" opacity=".08" fill="none"><path d="M14 14L14 50M14 14L50 14"/><path d="M1906 14L1906 50M1906 14L1870 14"/><path d="M14 1066L14 1030M14 1066L50 1066"/><path d="M1906 1066L1906 1030M1906 1066L1870 1066"/></g></svg>:null}

<header style={{position:"fixed",top:0,left:0,right:0,zIndex:20,padding:"6px 16px",display:"flex",justifyContent:"space-between",alignItems:"center",background:T.headerBg,backdropFilter:"blur(12px)",pointerEvents:"none"}}>
<div style={{display:"flex",alignItems:"center",gap:12,pointerEvents:"auto"}}>
<div style={{width:36,height:36,borderRadius:8,border:"1.5px solid "+T.ac+"30",background:"linear-gradient(135deg,"+T.ac+"15,"+T.a2+"10)",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 0 14px "+T.ac+"18"}}><svg viewBox="0 0 24 24" fill="none" width={19} height={19}><path d="M12 2L2 7l10 5 10-5-10-5z" stroke={T.ac} strokeWidth="1.3" fill={T.ac+"15"}/><path d="M2 17l10 5 10-5" stroke={T.a2} strokeWidth="1.3"/><path d="M2 12l10 5 10-5" stroke={T.ac} strokeWidth="1.3" opacity=".5"/></svg></div>
<div><div style={{fontFamily:T.hd,fontWeight:900,letterSpacing:4,fontSize:18,background:"linear-gradient(90deg,"+T.ac+","+T.a2+" 40%,"+T.ac+" 80%)",backgroundSize:"200% 100%",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",animation:"ls 6s ease infinite"}}>NEXTERA AI</div>
<div style={{fontWeight:400,letterSpacing:2.5,fontSize:8,color:T.dm,marginTop:1}}>L&T Engineering Services {"\u2022"} Global Command Center</div></div></div>
<div style={{display:"flex",alignItems:"center",gap:6,pointerEvents:"auto"}}>
<div style={{display:"flex",gap:3}}>{VIEWS.map(v=><button key={v.id} onClick={()=>{setView(v.id);setSel(null)}} style={{background:view===v.id?T.btnBg:isDark?"rgba(255,255,255,.04)":"rgba(0,0,0,.04)",border:view===v.id?"1.5px solid "+T.btnBorder:"1.5px solid "+(isDark?"rgba(255,255,255,.12)":"rgba(0,0,0,.12)"),borderRadius:5,padding:"5px 10px",color:view===v.id?T.btnTx:T.mt,fontSize:9,fontWeight:view===v.id?700:500,cursor:"pointer",fontFamily:T.mn,whiteSpace:"nowrap",letterSpacing:.5}}><span style={{marginRight:3}}>{v.i}</span>{v.l}</button>)}</div>
<button onClick={()=>setAgentOpen(!agentOpen)} style={{background:agentOpen?"linear-gradient(135deg,"+T.ac+"35,"+T.a2+"25)":T.btnBg,border:"1.5px solid "+T.btnBorder,borderRadius:6,padding:"4px 12px",color:T.btnTx,fontSize:9,fontWeight:700,cursor:"pointer",fontFamily:T.hd,letterSpacing:2,boxShadow:agentOpen?"0 0 12px "+T.ac+"20":"none"}}>\uD83E\uDD16 NEXTERA AI</button>
<select value={theme} onChange={e=>{setTheme(e.target.value);setSel(null)}} style={{height:26,borderRadius:5,border:"1.5px solid "+T.btnBorder,background:T.btnBg,color:T.btnTx,padding:"0 8px",fontFamily:T.mn,fontSize:8,outline:"none",cursor:"pointer",fontWeight:600}}>{Object.entries(TH).map(e=><option key={e[0]} value={e[0]}>{e[1].ic} {e[1].nm}</option>)}</select>
...
<div style={{position:"fixed",top:34,left:0,right:0,zIndex:18,pointerEvents:"none",background:isDark?"rgba(0,0,0,.15)":"rgba(255,255,255,.25)",borderBottom:"1px solid "+T.cardBorder,borderTop:"1px solid "+T.cardBorder}}><TickerBar T={T}/></div>

<div style={{position:"fixed",top:56,left:8,zIndex:10,display:"flex",flexDirection:"column",gap:4,width:185,pointerEvents:"auto"}}>
...
<G title="FILTER" icon={"\uD83D\uDD0D"} glow={T.ac} delay={380} T={T}><div style={{display:"flex",flexWrap:"wrap",gap:3}}>{[{id:"all",l:"ALL"},{id:"factory",l:"FAC"},{id:"warehouse",l:"WH"},{id:"port",l:"PORT"},{id:"lab",l:"R&D"},{id:"hq",l:"HQ"}].map(f=><button key={f.id} onClick={()=>setFilter(f.id)} style={{background:filter===f.id?T.btnBg:isDark?"rgba(255,255,255,.03)":"rgba(0,0,0,.03)",border:"1.5px solid "+(filter===f.id?T.btnBorder:isDark?"rgba(255,255,255,.10)":"rgba(0,0,0,.10)"),borderRadius:4,padding:"2px 6px",color:filter===f.id?T.btnTx:T.mt,fontSize:7,cursor:"pointer",fontFamily:T.mn,fontWeight:filter===f.id?700:500}}>{f.l}</button>)}</div></G>
...
<div style={{position:"fixed",top:56,right:8,zIndex:10,display:"flex",flexDirection:"column",gap:4,width:306,pointerEvents:"auto",maxHeight:"calc(100vh - 85px)",overflow:"auto"}}>{rightPanel()}</div>

{!sel?<div style={{position:"fixed",bottom:26,left:200,right:314,zIndex:10,display:"flex",gap:4,pointerEvents:"auto"}}>
...
{view==="overview"?<div style={{flex:1,height:132}}><G title="TOP FACILITIES" icon={"\uD83C\uDFC6"} glow={T.a2} delay={440} T={T} style={{height:"100%"}}><div style={{width:"100%",height:"100%"}}><ResponsiveContainer width="100%" height="100%"><BarChart data={SM.top.slice(0,6).map(f=>({name:f.n.substring(0,8),rev:Math.round(f.rev/1000),eff:f.eff}))} margin={{left:-5,right:2,top:2,bottom:0}}><CartesianGrid strokeDasharray="2 6" stroke={T.gr}/><XAxis dataKey="name" stroke={T.dm} fontSize={5.5} tickLine={false}/><YAxis stroke={T.dm} fontSize={6} tickLine={false}/><Tooltip content={<CT/>}/><Bar dataKey="rev" fill={T.a2} barSize={7} name="Rev $M" radius={[2,2,0,0]}/></BarChart></ResponsiveContainer></div></G></div>:null}
{view==="overview"?<div style={{flex:0.8,height:132}}><G title="MATERIAL SUPPLY" icon={"\u26A0"} glow={T.dg} delay={460} T={T} style={{height:"100%"}}><div style={{overflow:"auto",maxHeight:"100%"}}>{MAT_S.map((s,i)=><div key={i} style={{display:"flex",justifyContent:"space-between",alignItems:"center",fontSize:8,fontFamily:T.mn,padding:"2px 0"}}><span style={{color:T.tx}}>{s.n}</span><span style={{color:s.s==="Critical"?T.dg:s.s==="Tight"?T.wr:s.s==="Surplus"?T.pr:T.a2,fontWeight:700,fontSize:7}}>{s.s} {s.t>0?"+":""}{s.t}%</span></div>)}</div></G></div>:null}
</div>:null}

<div style={{position:"fixed",bottom:4,left:"50%",transform:"translateX(-50%)",zIndex:15,display:"flex",gap:4,pointerEvents:"none"}}>{[{l:"IN TRANSIT",v:shC["In Transit"]||0,c:T.ac},{l:"DELAYED",v:(shC.Delayed||0)+(shC.Exception||0),c:T.dg},{l:"AT PORT",v:shC["At Port"]||0,c:T.pr},{l:"CUSTOMS",v:shC.Customs||0,c:T.wr},{l:"DELIVERED",v:shC.Delivered||0,c:T.a2}].map((k,i)=><div key={i} style={{pointerEvents:"auto",background:T.cardBg,backdropFilter:"blur(14px)",border:"1.5px solid "+T.cardBorder,borderRadius:6,padding:"3px 10px",textAlign:"center",minWidth:65,animation:"hu .5s ease "+(500+i*60)+"ms both"}}><div style={{fontFamily:T.hd,fontSize:11,fontWeight:700,color:k.c}}>{k.v}</div><div style={{fontFamily:T.mn,fontSize:7,letterSpacing:1.2,color:T.dm,textTransform:"uppercase"}}>{k.l}</div></div>)}</div>
